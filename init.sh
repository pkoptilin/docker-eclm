...
#sed "s/<protocol type=\"MPING\" socket-binding=\"jgroups-mping\"\/>/<protocol type=\"TCPPING\"><property name=\"initial_hosts\">localhost\[7600\]<\/property><property name=\"port_range\">0<\/property><\/protocol>/" /opt/jboss/wildfly/standalone/configuration/standalone-full-ha.xml
...
sed -i.bak '/subsystem xmlns="urn:jboss:domain:infinispan:2.0"/r cache-container.xml' /opt/jboss/wildfly/standalone/configuration/standalone-full-ha.xml
